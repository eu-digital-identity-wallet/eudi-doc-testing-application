@ANDROID @manual @US_RIAWIOUR @Q1_2026
Feature: User Authentication and Re-Issuance of PIDs/Attestations
  ...
  @US_RIAWIOUR_TC_01 @manual:Passed
  ...
  @US_RIAWIOUR_TC_02 @manual:Passed
  ...
  @US_RIAWIOUR_TC_03 @manual:Passed
  ...
  @US_RIAWIOUR_TC_04 @manual:Passed
  ...
  @US_RIAWIOUR_TC_05 @manual:Passed
  ...
  @US_RIAWIOUR_TC_06 @manual:Passed
