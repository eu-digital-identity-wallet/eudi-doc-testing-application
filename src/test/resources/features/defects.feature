Feature: Defects
  ...
  This feature provides a comprehensive list of all reported bugs. Each reported issue includes detailed information such as smartphone attributes, application attributes, bug description, steps to reproduce, expected behavior and screenshots. To view the complete list of reported bugs, please visit our GitHub issues page
