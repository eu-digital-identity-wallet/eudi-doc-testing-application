...
Feature: Present Digital Attestations via Browser using EUDI Wallet on Same Device
  ...
  #https://github.com/eu-digital-identity-wallet/eudi-doc-testing-application/issues/322

  @US_RAPDCAPICD_TC_01 @manual:Passed
  Scenario: User initiates verification from browser on their mobile device
  ...
  Scenario: Browser does not request permission for Digital Credentials API
