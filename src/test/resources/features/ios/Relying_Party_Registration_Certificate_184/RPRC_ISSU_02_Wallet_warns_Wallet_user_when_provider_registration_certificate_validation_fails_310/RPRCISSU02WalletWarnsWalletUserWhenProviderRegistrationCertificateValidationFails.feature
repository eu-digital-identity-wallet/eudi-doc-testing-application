...
Feature: Warning when the provider's registration certificate cannot be validated
  ...
  @US_WWWUWPRCVF_TC_02 @manual:Ignored
  ...
  @US_WWWUWPRCVF_TC_03 @manual:Ignored
  Scenario: User cancels from the blocker and returns to the issuance initiation request page
