...
Feature: Issuance and presentation - PID (SD-JWT)
  ...
  Scenario Outline: Successful credential issuance and presentation with selective disclosure - Python Issuer - PID (SD-JWT)
    ...
    Then the verifier verifies the credential successfully with <presentation_scenario> for <selective_disclosure>
    Examples:
      |  | credential   | issuer | issuance_method  | issue_scenario | verifier     | presentation_scenario | selective_disclosure |  | issuer | issuance_method  | issue_scenario | verifier     | presentation_scenario | selective_disclosure |
      |  | PID (SD-JWT) | Kotlin | from list        | same device    | Web verifier | same device           | specific attributes  |  | Kotlin | from list        | same device    | Web verifier | same device           | specific attributes  |
      |  | PID (SD-JWT) | Kotlin | from list        | same device    | Web verifier | cross device          | specific attributes  |  | Kotlin | credential offer | cross device   | Web verifier | cross device          | specific attributes  |
      |  | PID (SD-JWT) | Kotlin | credential offer | same device    | Web verifier | same device           | specific attributes  |  |        |                  |                |              |                       |                      |
      |  | PID (SD-JWT) | Kotlin | credential offer | same device    | Web verifier | cross device          | specific attributes  |  |        |                  |                |              |                       |                      |
      |  | PID (SD-JWT) | Kotlin | credential offer | cross device   | Web verifier | same device           | specific attributes  |  |        |                  |                |              |                       |                      |
      |  | PID (SD-JWT) | Kotlin | credential offer | cross device   | Web verifier | cross device          | specific attributes  |  |        |                  |                |              |                       |                      |
