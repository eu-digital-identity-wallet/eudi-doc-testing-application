@ANDROID @manual @US_DLODFS @Q4_2024
Feature: Select Document to be Signed
  ...
  #https://github.com/eu-digital-identity-wallet/eudi-doc-testing-application/issues/195

  @US_DLODFS_TC_01 @manual:Passed
