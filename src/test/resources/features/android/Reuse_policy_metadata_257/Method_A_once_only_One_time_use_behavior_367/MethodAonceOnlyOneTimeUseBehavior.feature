...
Feature: One-time-use attestation issuance under Method A (once_only)
  ...
  @US_MAOOTUB_TC_08
  Scenario: Background reissuance is triggered silently once the threshold is reached
  ...
  @US_MAOOTUB_TC_09
  Scenario: Counter resets to full after reissuance completes
