...
public class WalletElements {
    ...
    public static By clickGivenName = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeTextField[2]");
    public static By givenNameField = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeTextField[2]");
    public static By clickFamilyName = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeTextField[1]");
    public static By givenFamilyField = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeTextField[1]");
    public static By clickBirthDate = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeOther[5]");
    ...
    public static By enterDocumentNumber = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeTextField[3]");
    public static By documentNumberField = By.xpath("//XCUIElementTypeOther[@name=\"form\"]/XCUIElementTypeTextField[3]");
    public static By clickScreen = By.xpath("//XCUIElementTypeStaticText[@name=\"Value\"]");
    public static By clickIssueDate = By.xpath("//XCUIElementTypeOther[@name=\"Vehicle Category Code Issue Date Expiry Date Codes Code Sign Value\"]/XCUIElementTypeOther[4]");
    public static By clickExpiryDate = By.xpath("//XCUIElementTypeOther[@name=\"Vehicle Category Code Issue Date Expiry Date Codes Code Sign Value\"]/XCUIElementTypeOther[6]");
    ...
    public static By clickDrivingLicenceButton = By.xpath("//XCUIElementTypeStaticText[contains(@name, \"mDL\") or contains(@name, \"eu.europa.ec.eudi.mdl_mdoc\") or contains(@name, \"mdl_doctype_name\")]");
    ...
    public static By detailsOfDocument = By.xpath("//XCUIElementTypeStaticText[@name=\"family_name\"]");
    ...
    public static By clickPID = By.xpath("//XCUIElementTypeStaticText[contains(@name, \"PID\") or contains(@name, \"eu.europa.ec.eudi.pid_mdoc\") or contains(@name, \"eu_pid_doctype_name\")]");
    ...
    public static By secondPidIsDisplayed = By.xpath("(//XCUIElementTypeStaticText[@name=\"eu_pid_doctype_name\"])[2]");
    public static By clickSecondPID = By.xpath("(//XCUIElementTypeStaticText[@name=\"eu_pid_doctype_name\"])[2]");
