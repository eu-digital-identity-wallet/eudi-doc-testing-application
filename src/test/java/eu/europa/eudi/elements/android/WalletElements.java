...
//    public static By clickGivenName = By.xpath("//android.view.View[@resource-id=\"eidasCountries\"]/android.view.View[2]/android.widget.EditText");
    ...
    public static By clickIssueDate = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View[2]/android.widget.Spinner[1]");
    public static By clickExpiryDate = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View[2]/android.widget.Spinner[2]");
    ...
    public static By codeFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[2]/android.widget.EditText[1]");
    public static By signFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[2]/android.widget.EditText[2]");
    public static By valueFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[2]/android.widget.EditText[3]");
    ...
    public static By enterCodeFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[2]/android.widget.EditText[1]");
    public static By enterSignFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[2]/android.widget.EditText[2]");
    public static By enterValueFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[2]/android.widget.EditText[3]");
