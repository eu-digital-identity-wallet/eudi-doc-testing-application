...
//    public static By clickGivenName = By.xpath("//android.view.View[@resource-id=\"eidasCountries\"]/android.view.View[2]/android.widget.EditText");
    ...
    public static By eyeIcon = By.xpath("//androidx.compose.ui.platform.i0/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.widget.Button");
    ...
    public static By clickBackButton = By.xpath("//androidx.compose.ui.platform.i0/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.widget.Button");
    ...
    public static By clickCountry = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View[3]/android.widget.EditText");
    ...
    public static By clickAgeOver18 = By.xpath("(//android.widget.CheckBox[@resource-id=\"check\"])[4]");
