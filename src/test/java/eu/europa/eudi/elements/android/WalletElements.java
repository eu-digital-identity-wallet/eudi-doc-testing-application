...
public class WalletElements {
    ...
    public static By unselectData = By.xpath("//android.widget.TextView[@text=\"birth_date\"]");
...
//    public static By clickGivenName = By.xpath("//android.view.View[@resource-id=\"eidasCountries\"]/android.view.View[2]/android.widget.EditText");
    ...
    public static By clickDrivingLicenceButton = By.xpath("//android.widget.TextView[@text=\"eu.europa.ec.eudi.mdl_mdoc\"]");
    ...
    public static By clickIssueDate = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.widget.Spinner[1]");
    public static By clickExpiryDate = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.widget.Spinner[2]");
    ...
    public static By clickScreen = By.xpath("//android.widget.TextView[@text=\"Codes\"]");
    ...
    public static By issuanceDetails = By.xpath("//android.widget.TextView[@text=\"eu.europa.ec.eudi.pid.1\"]");
    ...
    public static By verificationDetails = By.xpath("//android.widget.TextView[@text=\"birth_date\"]");
    ...
    public static By clickFromListNew = By.xpath("//android.widget.TextView[@text=\"From list\"]");
    ...
    public static By secondPidIsDisplayed = By.xpath("(//android.widget.TextView[@text=\"eu.europa.ec.eudi.pid.1\"])[2]");
    ...
    public static By transactionCodeField = By.xpath("//androidx.compose.ui.platform.h1/android.view.View/android.view.View/android.view.View/android.widget.EditText");
    ...
    public static By codeFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[5]/android.widget.EditText[1]");
    public static By signFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View/android.widget.EditText[2]");
    public static By valueFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View/android.widget.EditText[3]");
    ...
    public static By clickPIDOnDocuments = By.xpath("//android.widget.TextView[@text=\"eu.europa.ec.eudi.pid.1\"]");
    public static By enterCodeFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View[5]/android.widget.EditText");
    public static By enterSignFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View/android.widget.EditText[2]");
    public static By enterValueFieldIssuer = By.xpath("//android.view.View[@resource-id=\"selectCountryForm\"]/android.view.View/android.view.View/android.widget.EditText[3]");
