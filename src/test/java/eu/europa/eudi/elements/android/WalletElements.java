...
public class WalletElements {
    ...
    public static By clickLearningCredentialKotlin = By.xpath("//android.view.View[@resource-id=\"eu.europa.ec.euidi:id/add_document_screen_attestation_https://issuer-backend.eudiw.dev_urn:eu.europa.ec.eudi:learning:credential:1:dc+sd-jwt-compact\"]" + " | " + "//android.view.View[@resource-id=\"eu.europa.ec.euidi:id/add_document_screen_attestation_https://issuer-backend.eudiw.dev_urn:eu.europa.ec.eudi:learning:credential:1:dc+sd-jwt-compact\"]/android.view.View" + " | " + "//android.view.View[@resource-id=\"eu.europa.ec.euidi:id/add_document_screen_attestation_https://issuer-backend.eudiw.dev_urn:eu.europa.ec.eudi:learning:credential:1:dc+sd-jwt-compact\"]/android.view.View/android.view.View" + " | " + "//android.view.View[@resource-id=\"eu.europa.ec.euidi.dev:id/add_document_screen_attestation_https://issuer-backend.eudiw.dev_urn:eu.europa.ec.eudi:learning:credential:1:dc+sd-jwt-compact\"]" + " | " + "//android.view.View[@resource-id=\"eu.europa.ec.euidi.dev:id/add_document_screen_attestation_https://issuer-backend.eudiw.dev_urn:eu.europa.ec.eudi:learning:credential:1:dc+sd-jwt-compact\"]/android.view.View" + " | " + "//android.view.View[@resource-id=\"eu.europa.ec.euidi.dev:id/add_document_screen_attestation_https://issuer-backend.eudiw.dev_urn:eu.europa.ec.eudi:learning:credential:1:dc+sd-jwt-compact\"]/android.view.View/android.view.View");
    ...
    public static By walletHomeScreenDisplayed = By.xpath("//android.widget.TextView[contains(@text, \"Welcome\")]");
