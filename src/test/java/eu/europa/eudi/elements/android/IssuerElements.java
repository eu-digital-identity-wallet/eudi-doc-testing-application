...
public class IssuerElements {
    ...
    public static By clickPersonalIdentificationData = By.xpath("//android.webkit.WebView[@text=\"Request Credentials for your EUDI Wallet\"]/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.view.View/android.widget.CheckBox");
