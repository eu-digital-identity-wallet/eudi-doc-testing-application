...
public class IssuerElements {
    ...
    public static By secondAttribute = By.xpath("//android.view.View[@resource-id=\"mat-option-2\"]");
    ...
    public static By clickFormat = By.xpath("//android.widget.Spinner[@resource-id=\"mat-select-1\"]/android.view.View/android.widget.TextView[2]");
}
