...
//            birthPlace.sendKeys("Thessaloniki");
    ...
    public void clickAgeOver18() {
        if (test.getSystemOperation().equals(Literals.General.ANDROID.label)) {
            ...
            test.mobileWebDriverFactory().getWait().until(ExpectedConditions.visibilityOfElementLocated(eu.europa.eudi.elements.ios.WalletElements.clickAgeOver18)).click();
        }
    }
...
//            vehicleCategoryCode.sendKeys("123");
    ...
    public void enterCodeFieldIssuer() {
        if (test.getSystemOperation().equals(Literals.General.ANDROID.label)) {
            ...
            WebElement codeField = test.mobileWebDriverFactory().getWait().until(ExpectedConditions.elementToBeClickable(eu.europa.eudi.elements.android.WalletElements.enterCodeFieldIssuer));
            codeField.clear();
